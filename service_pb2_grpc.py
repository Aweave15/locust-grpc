...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessRequests = channel.stream_unary(
                '/example.Greeter/ProcessRequests',
                request_serializer=service__pb2.HelloRequest.SerializeToString,
                response_deserializer=service__pb2.HelloReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessRequests': grpc.stream_unary_rpc_method_handler(
...
class Greeter(object):
    ...
    def ProcessRequests(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/example.Greeter/ProcessRequests',
            service__pb2.HelloRequest.SerializeToString,
            service__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
